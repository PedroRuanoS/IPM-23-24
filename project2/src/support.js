...
{ 
  ...
  start_button.position(width/2 - start_button.size().width/2, height/1.05 - start_button.size().height/2);
  
  //4. Example image
  image(img, width/2 - 687.05/2, height/2 - 242/2, 687.05, 324.35);
}
